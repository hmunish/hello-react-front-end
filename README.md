...
**[Hello_React_FrontEnd]** is a Hello world project to learn about rails & react in two apps.
...
<summary>Client</summary>
  <ul>
    <li><a href="https://www.reactjs.com/">ReactJS</a></li>
  </ul>
</details>
...
```sh
  cd my-folder
  git clone git@github.com:myaccount/hello-react-front-end.git
```
